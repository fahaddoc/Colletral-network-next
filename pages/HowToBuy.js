    ...
    return (
        <>
            ...
            <main class="main">
                ...
                <section class="buy-banner d-flex align-items-center">
                    <div class="container">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-7">
                                <h1 class="text-center main-banner__title">Get in <span class="highlight">early</span>
                                </h1>
                                <p class="main-banner__description">Hurry! There is no better time than NOW to get your hands on
                                    Collateral Network tokens!</p>
                                ...
                                <div class="read-more read-more-js">
                                    <div class="read-more__text">Read more</div>
                                    <i class="icomoon-arrow-phase"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section contact-us">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-4">
                                <h2 class="section__title contact-us__title text-center">Talk <span class="highlight">To Us</span></h2>
                                <p class="section__description contact-us__description text-center">Leave your details and we will contatct you
                                ...
                                <form class="form" action="#">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckChecked">
                                            By submitting this form, you agree to our <a href="#">Terms</a> and <a href="#">Privacy Policy</a>
                                        </label>
                                    </div>
